...
export const FPS = 60,
  TOTAL = 2160;
export const SHOTS = {
  open: { from: 0, duration: 240 },
  context: { from: 240, duration: 300 },
  listen: { from: 540, duration: 360 },
  answer: { from: 900, duration: 420 },
  screen: { from: 1320, duration: 420 },
  outro: { from: 1740, duration: 420 },
};
const C = {
  bg: "#080c13",
  surface: "#101721",
  ...
  return (
    <Frame>
      ...
      <Head
        ...
        cue={18}
      />
      <Caption cue={105}>你的 AI 面试助手</Caption>
    </Frame>
  );
};
const Context: React.FC = () => {
  ...
  return (
    <Frame section="01 / 个性化资料">
      <Head
        title="回答，从你的经历出发。"
        sub="简历、职位 JD、知识库，关联到同一场面试"
      />
      <div
        style={{
          position: "absolute",
      ...
      <Caption>让回答贴合岗位，也更像你自己。</Caption>
    </Frame>
  );
};
    ...
    <Frame section="02 / 实时对话">
      ...
      <Caption>
        {f < 250 ? (
          ...
          <span>
            需要回答时，点击 <b style={{ color: C.brand }}>快答</b>。
          </span>
        )}
      </Caption>
    </Frame>
    ...
    <Frame section="03 / 回答思路">
      ...
      >
        ...
        >
          <Crop
            src="live-full"
            rect={{ x: simple.x, y: simple.y + 40, w: 710, h: 38 }}
            width={1600}
          />
        </div>
      ...
      <Caption>结合你的资料，把回答组织得更有条理。</Caption>
    </Frame>
  );
};
...
const Screen: React.FC = () => {
  ...
  return (
    <Frame section="04 / 截屏回答">
      <Head
        title="遇到屏幕上的题，也有思路。"
        sub="主动截取题目，继续在当前工作区查看回答"
      />
      <div
        style={{
          position: "absolute",
      ...
      <Caption>
        {f < 165 ? (
          <span>
            点击 <b style={{ color: C.brand }}>截屏回答</b>，开始分析。
          </span>
        ) : (
          "读懂题目，梳理解题路径。"
        )}
  ...
  return (
    <Frame section="为下一场面试做好准备">
      ...
      >
        ...
        >
          让每一次回答，<span style={{ color: C.brand }}>更有把握。</span>
        </div>
        <div
          style={{
            fontSize: 36,
