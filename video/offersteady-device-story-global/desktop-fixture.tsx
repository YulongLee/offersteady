...
window.offersteady = {
getDesktopConfig:async()=>({appVersion:'1.2.17',platform:'macos',architecture:'arm64',platformVersion:'15',protocolVersion:'1',captureRuntime:'electron-single-owner',webWorkspaceUrl:'http://127.0.0.1:5191/app',apiBaseUrl:'http://127.0.0.1:9',realtimeEndpointing:{mode:'commercial-adaptive'}}),
getPairingIdentity:async()=>({deviceId:'synthetic-desktop',manualCode:'628391',displayName:'Demo Mac'}),
