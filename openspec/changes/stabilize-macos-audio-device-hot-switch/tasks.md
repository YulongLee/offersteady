...
- [x] 4.4 Publish the verified 1.1.6 companion manifests and verify production health and download checksums.
- [x] 4.5 Perform metadata-only production validation and leave physical headset-removal acceptance pending for the user.
