...
- [ ] 1.4 Commit and push the verified 1.2.0 release source before packaging production artifacts.
...
- [ ] 2.2 Build, verify, notarize, and staple the macOS arm64 1.2.0 artifact.
- [ ] 2.3 Build, verify, notarize, and staple the macOS x64 1.2.0 artifact.
- [ ] 2.4 Build and structurally validate the Windows x64 1.2.0 installer with truthful signing metadata.

## 3. Publication and Deployment

- [ ] 3.1 Upload immutable artifacts and atomically generate the production release manifest.
