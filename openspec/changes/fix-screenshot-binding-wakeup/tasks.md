...
- [x] 3.2 Confirm zero active interviews immediately before deployment.
- [x] 3.3 Deploy the domestic backend manifest update and verify health, downloads and initial error/latency metrics.
