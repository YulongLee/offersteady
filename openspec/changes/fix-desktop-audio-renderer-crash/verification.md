...
- Controlled 1.1.2 production playback used session `session-2744b3c52c4946d1a8ba74293df482a9`: exactly one mixed publisher remained active throughout the observation, system frame count advanced from 1,477 to 1,717 and sequence advanced from 1,540 to 1,794 over 30 seconds, every sampled receipt was `accepted` with no error, and transcript metadata reached 40 system entries. No publisher replacement loop or sequence-gap error was observed. Transcript text and audio were not collected.
