...
- [x] Add a durable, seeded billing catalog migration.
- [x] Read the active catalog from the billing persistence layer.
- [x] Add guarded admin list and update endpoints.
- [x] Add the admin product-pricing workspace.
