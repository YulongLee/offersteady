...
const exact = new Map(Object.entries({
  ...
  "仅使用 Mac 麦克风": "Mac microphone only",
  ...
  "捕捉屏幕": "Capture screen",
  "收音已就绪": "Audio ready",
  "收听手机扬声器与现场声音": "Listen to the phone speaker and room audio",
  "显示器 1": "Display 1",
  ...
  "本场停用": "Disabled for this interview",
  "无需设置": "No setup needed",
  "现场声音": "Room audio",
  ...
  "电脑输出": "System audio",
  "手机面试不采集电脑系统音频": "Mobile interviews do not capture computer system audio",
  ...
  "手机面试已开始，本地助手仅使用 Mac 麦克风收听现场声音。": "The mobile interview has started. The companion is using only the Mac microphone for room audio.",
  "面试稳": "OfferSteady",
  ...
  "Mac 麦克风没有成功启动，请检查麦克风授权和设备选择。": "The Mac microphone could not start. Check microphone permission and the selected device.",
