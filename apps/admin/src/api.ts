...
export const adminApi = {
  ...
  revealPartnerPayout: (payoutId: string) => request<Record<string, unknown>>(`/api/v1/admin/promotion/partner-payouts/${encodeURIComponent(payoutId)}/reveal`, { method: "POST" }),
