...
function LandingPage() {
  ...
  return (
    <main>
      ...
      <footer className="public-footer"><div className="public-footer-main"><section className="footer-brand"><Logo /><p>面向求职者的 AI 面试辅助工具，从资料准备、现场表达建议到面试复盘，让每一次面试更有条理。</p><span>AI 输出仅供参考，请始终以真实经历作答。</span></section><nav className="footer-column" aria-label="页脚产品导航"><h2>产品</h2><a href="/features">产品功能</a><a href="/features/ai-interview-assistant">AI 面试助手</a><a href="/features/realtime-interview">实时面试辅助</a><a href="/features/screenshot-answer">截图回答</a><a href="/features/interview-review">面试复盘</a><a href="/pricing">积分与会员</a><a href="/download">下载助手</a></nav><nav className="footer-column" aria-label="页脚资源导航"><h2>资源</h2><a href="/interview-questions">面试题与专题</a><a href="/guides">面试指南</a><Link to={routes.publicGuide}>使用手册</Link><Link to={`${routes.publicGuide}#desktop`}>下载安装说明</Link><a href="/guides/interview-preparation">面试准备清单</a><a href="/guides/star-interview-answer">STAR 回答结构</a><a href="/guides/audio-troubleshooting">收音问题排查</a><a href="/security">安全说明</a><a href="/about">关于产品</a><a href="/contact">联系我们</a><Link to={routes.terms}>用户协议</Link><Link to={routes.privacy}>隐私政策</Link></nav><section className="footer-contact"><h2>联系我们</h2><dl><div><dt>客服微信</dt><dd>{state.billing.support.wechatId || "暂未配置"}</dd></div><div><dt>联系邮箱</dt><dd>{state.billing.support.email ? <a href={`mailto:${state.billing.support.email}`}>{state.billing.support.email}</a> : "暂未配置"}</dd></div><div><dt>服务时间</dt><dd>{state.billing.support.serviceHours || "请通过邮箱留言"}</dd></div></dl><p>咨询订单时请提供订单号，请勿发送密码、验证码或完整身份资料。</p></section></div><div className="public-footer-legal"><span>© 2026 面试稳AI助手 · OneShow AI Lab</span><a href="https://beian.miit.gov.cn" target="_blank" rel="noreferrer">浙ICP备2026052190号-1</a></div></footer>
    </main>
  );
}
