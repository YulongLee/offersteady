...
function LandingPage() {
  ...
  return (
    <main>
      ...
      {partnerProgramEnabled ? <section className="partner-home-entry" aria-labelledby="partner-home-entry-title"><div><span className="kicker">PARTNER PROGRAM</span><h2 id="partner-home-entry-title">合作伙伴计划</h2><p>分享面试稳，获得 20% 推广佣金。</p></div><Link className="button primary large" to={routes.partnerProgram}>了解合作伙伴计划 <span>→</span></Link></section> : null}
