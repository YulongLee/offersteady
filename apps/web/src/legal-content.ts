export const updatedAt = "2026 年 9 月 1 日";
...
export const termsSections = [
  ...
  ["七、终止与联系", [
    ...
    "如对本协议有疑问，请通过客服微信 mianshiwen_01 或邮箱 contact@oneshowailab.com 联系。",
  ]],
] as const;
...
export const privacySections = [
  ...
  ["七、更新与联系", [
    ...
    "隐私问题可通过客服微信 mianshiwen_01 或邮箱 contact@oneshowailab.com 联系。请勿通过客服渠道发送密码、验证码或完整身份证件。",
  ]],
] as const;
