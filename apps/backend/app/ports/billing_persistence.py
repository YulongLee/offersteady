...
class BillingPersistencePort(Protocol):
    ...
    def activate_referral(self, *, invitee_user_id: str, referral_code: str, activated_at_ms: int, invitee_registered_at_ms: int | None, activation_deadline_ms: int | None) -> dict[str, object]: ...
