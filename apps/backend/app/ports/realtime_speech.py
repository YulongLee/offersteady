...
RealtimeEventKind = Literal["connection-state", "transcript-updated", "question-candidate", "question-confirmed", "answer-completed", "degraded", "device-status", "capture-control", "screenshot-shortcut-accepted"]
