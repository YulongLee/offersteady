...
class RuntimePerformanceAcknowledgementRequest(BaseModel):
    ...
    server_accepted_at_ms: int | None = Field(default=None, ge=0, alias="serverAcceptedAtMs")
    route_received_at_ms: int | None = Field(default=None, ge=0, alias="routeReceivedAtMs")
    executor_admitted_at_ms: int | None = Field(default=None, ge=0, alias="executorAdmittedAtMs")
    answer_generator_started_at_ms: int | None = Field(default=None, ge=0, alias="answerGeneratorStartedAtMs")
    provider_request_at_ms: int | None = Field(default=None, ge=0, alias="providerRequestAtMs")
    provider_first_token_at_ms: int | None = Field(default=None, ge=0, alias="providerFirstTokenAtMs")
    first_visible_at_ms: int | None = Field(default=None, ge=0, alias="firstVisibleAtMs")
    sse_yield_at_ms: int | None = Field(default=None, ge=0, alias="sseYieldAtMs")
