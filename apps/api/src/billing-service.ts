...
export class BillingService {
  ...
  constructor(products: readonly BillingProduct[] = defaultBillingProducts, readonly rates: UsageRates = defaultUsageRates, readonly support: BillingSupportConfig = { wechatId: "mianshiwen_01", email: "contact@oneshowailab.com", qrAssetPath: "", serviceHours: "工作日 10:00–18:00", refundSummary: "退款按订单状态和未使用权益人工审核" }) { products.forEach(product => this.products.set(product.id, product)); }
